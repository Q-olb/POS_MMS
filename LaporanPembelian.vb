...
Public Class LaporanPembelian
    ...
    Private Sub btnCheck_Click(sender As Object, e As EventArgs) Handles btnCheck.Click
        ...
        Try
            Dim LOKASI As String = KONEKSI
            Dim CNN As New OleDbConnection(LOKASI)
            If CNN.State = ConnectionState.Closed Then CNN.Open()
            Dim OLECMD As New OleDbCommand("Select * from Tbl_Pembelian where Month([Tgl_Pembelian]) = '" & num_bulan & "' and  Year([Tgl_Pembelian]) = '" & tahun & "'", CNN)
            Dim dread As OleDbDataReader = OLECMD.ExecuteReader
            dread.Read()
            If dread.HasRows Then
                Try
                    ...
                    If CNN.State = ConnectionState.Closed Then CNN.Open()
                    Dim da As New OleDbDataAdapter("Select * from Tbl_Pembelian where Month([Tgl_Pembelian]) = '" & num_bulan & "' and  Year([Tgl_Pembelian]) = '" & tahun & "'", CNN)
                    ...
                    Next
                    DataGridView1.Rows(max).Cells(3).Value = keterangan
                    DataGridView1.Rows(max).Cells(4).Value = total
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        ...
        Dim filePath As String = Path.Combine(downloadsFolder, "Laporan_Pembelian.pdf")
        ...
        Try
            ...
            ' Menambahkan judul "Maulana Motor Services"
            ...
            ' Menambahkan subjudul "Laporan Pembelian"
            Dim subJudul As New Paragraph("Laporan Pembelian " & cbBulan.Text & " " & cbTahun.Text)
            ...
            For Each row As DataGridViewRow In DataGridView1.Rows
                For Each cell As DataGridViewCell In row.Cells
                    If cell.Value IsNot Nothing Then
                        ...
                        cellText.Phrase.Font.Size = 8 ' Menetapkan ukuran font
            ...
            MessageBox.Show("PDF Laporan Pembelian telah didownload.")
